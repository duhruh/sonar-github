...
//      .build()));
//
//    GitHubPluginConfiguration config = new GitHubPluginConfiguration(new ConfigurationBridge(settings), new System2());
//    context = mock(PostJobContext.class);
//
//    settings.setProperty("sonar.host.url", "http://192.168.0.1");
//    settings.setProperty(CoreProperties.SERVER_BASE_URL, "http://myserver");
//    pullRequestIssuePostJob = new PullRequestIssuePostJob(config, pullRequestFacade, new MarkDownUtils(new ConfigurationBridge(settings)));
//  }
//
